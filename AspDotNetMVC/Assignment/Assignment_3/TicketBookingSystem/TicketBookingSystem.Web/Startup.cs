...
namespace TicketBookingSystem.Web
{
    public class Startup
    {
        ...
        {
            var connectionInfo = GetConnectionAndAsemblyName();

            builder.RegisterModule(new BookingModule(connectionInfo.connectionString, 
                connectionInfo.migrationAssemblyName));
        }

        private (string connectionString, string migrationAssemblyName) GetConnectionAndAsemblyName()
        {
            var connetionString = "DefaultConnection";
            var connetionStringName = Configuration.GetConnectionString(connetionString);
            var migrationAssemblyName = typeof(Startup).Assembly.FullName;

            return (connetionStringName, migrationAssemblyName);
        }
