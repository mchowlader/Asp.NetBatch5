...
using InventorySystem.Tracking;
...
namespace InventorySystem.Web
{
    public class Startup
    {
        ...
        public void ConfigureContainer(ContainerBuilder builder)
        {
            ...
            builder.RegisterModule(new TrackingModule(connectionInfo.connectionString, 
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationDbContext>(options =>
                options.UseSqlServer(connectionInfo.migrationsAssemblyName));

            services.AddDbContext<TrackinDbContext>(option => 
