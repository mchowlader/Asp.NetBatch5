...
using CRUD_Two.Training;
using CRUD_Two.Training.Context;
using CRUD_Two.Web.Data;
...
namespace CRUD_Two.Web
{
    public class Startup
    {
        ...
        {
            var connectionInfo = GetConntectionAndAssemblyName();

            builder.RegisterModule(new TrainingModule(connectionInfo.connectionString, 
                connectionInfo.migrationsAssemblyName));
        }

        private (string connectionString, string migrationsAssemblyName) GetConntectionAndAssemblyName()
        {
