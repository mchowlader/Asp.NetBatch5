using AttendanceSystem.Membership;
using AttendanceSystem.Membership.Contexts;
...
namespace AttendanceSystem.Web
{
    public class Startup
    {
        ...
        public void ConfigureContainer(ContainerBuilder builder)
        {
            ...
            builder.RegisterModule(new PresentModule(connectionInfo.connectionString,connectionInfo.migrationAssemblyName));
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<PresentDbContext>(option => 
